...
## 🧭 About Me
I am a Senior IT Specialist with expertise in spinning up virtual machines, administering SQL databases, and providing both technical and application support.  
I specialize in qualifying and validating cloud infrastructure to ensure compliance, security, and performance before migration.  
My experience spans AWS and Azure environments, PKI validation (Keyfactor), Splunk dashboards, and hands-on networking.
...
- **Data & SQL**
  - [SQL Server Lab](https://github.com/Watchcat25/sql-server-lab) — partitioning, indexing, backup/restore, RPO/RTO drills
  - [DB Performance Lab](https://github.com/Watchcat25/db-performance-lab) — workload generator + experiments

- **Security & Validation**
  - [PKI Validation (Keyfactor)](https://github.com/Watchcat25/pki-validation-keyfactor) — sanitized IQ/OQ/PQ templates + scripts
...
- **Networking**
  - [OpenWRT Router Setup](https://github.com/Watchcat25/openwrt-router-setup) — configs, VLANs, firewall, QoS
